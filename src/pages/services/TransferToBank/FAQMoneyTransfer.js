...
const FAQMoneyTransfer = () => {
  ...
  const content = [
    {
      title: "About Domestic Money Transfer via Finunique",
      body: (
        <>
          <p>
            Finunique Small Private Limited. offers a robust, bank-grade platform for secure online domestic money transfers. Whether you're transferring funds to a friend, sending money home, or helping customers with bank transactions as a retailer, Finunique enables real-time money transfers to any bank account in India.
          </p>
          <p>
    ...
    {
      title: "How to Send Money Online via Finunique",
      body: (
        <>
          <ul>
            <li>Log in to your Finunique dashboard or mobile app</li>
            ...
            <li>Confirm payment using your Finunique wallet balance or linked payment method</li>
      ...
      body: (
        <>
          <ul>
            ...
            <li>Get onboarding, support, and tools from Finunique</li>
          </ul>
        </>
      ),
    },
      ...
      body: (
        <Accordion flush>
          <Accordion.Item eventKey="0">
            ...
            <Accordion.Body>Yes. Finunique supports transfers to all major banks using IMPS, NEFT, and UPI.</Accordion.Body>
          </Accordion.Item>
          ...
          <Accordion.Item eventKey="4">
            ...
            <Accordion.Body>Yes. Retailers can become Finunique agents and provide cash deposit & money transfer services to customers.</Accordion.Body>
          </Accordion.Item>
        </Accordion>
      ),
    },
    {
      ...
      body: (
        <>
          <p>
            Whether you're transferring funds for family, business, or community support — trust Finunique for fast, secure, and compliant online money transfers across India.
          </p>
